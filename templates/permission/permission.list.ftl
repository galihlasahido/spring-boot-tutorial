...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="${rc.getContextPath()}/role/permission/list">${rc.getMessage('permission.title.list')}</a></li>
    </ol>
</section>
<div>&nbsp;</div>
    <#if flashmessage??>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>&nbsp;${row.label!}</td>
                                <td>&nbsp;${row.value!}</td>
                                <td>&nbsp;<a href="${rc.getContextPath()}/role/permission/delete/${row.id!}"><span class="glyphicon glyphicon-trash remove-data"></span></a>
                                    <a href="${rc.getContextPath()}/role/permission/edit/${row.id!}"><span class="glyphicon glyphicon-wrench"></span></a>
                                </td>
                            </tr>
                            </#list>
