    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="${rc.getContextPath()}/role/permission/action.edit/${RequestParameters.id!}" method="post">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="label">${rc.getMessage('permission.data.label')}</label>
                            <input type="text" name="label" class="form-control" id="label" value="${RequestParameters.label!}">
                        </div>
                        <div class="form-group">
                            <label for="value">${rc.getMessage('permission.data.value')}</label>
                            <input type="text" name="value" class="form-control" id="value" value="${RequestParameters.value!}>
                        </div>
