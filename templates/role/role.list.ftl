...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="${rc.getContextPath()}/role/list">${rc.getMessage('role.title.list')}</a></li>
    </ol>
</section>
<div>&nbsp;</div>
                            ...
                            <div class="input-group">
                                <div class="input-group-btn">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="#"><input type="radio" name="mode" value="idrole" checked="checked"> ${rc.getMessage('role.data.idrole')}</a></li>
                                        <li><a href="#"><input type="radio" name="mode" value="name"> ${rc.getMessage('role.data.name')}</a></li>
                                    </ul>
                                </div>
